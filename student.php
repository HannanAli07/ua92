...
<body>
  <nav class="navbar navbar-expand-lg navbar-light py-0 fixed-top" style="background-color: #0f0f0f;">
      <div class="container">
        ...
        <a href="index.php"><img src="Logo2.png" alt="" width="180" height="100"></a>
  ...
  <div class="container-fluid mt-5 py-5">
    ...
    <h3>See All Students</h3>
        ...
        <?php
          ...
          $sql = mysqli_query($connect, "SELECT Student_ID, First_Name, Last_name, 
          Student_Age, Home_Address, Parents_ID, Class_ID  FROM students");
    ...
    <br>
      ...
      if (isset($_POST['addstudent'])) {
        ...
        Last_Name, Student_Age, Home_Address, Parents_ID, Class_ID) VALUES ('$S_ID', 
        '$Student_Name', '$Last_Name', '$S_age', '$S_address', 
        '$Parents_Id', '$ClassName')";
			  echo $sql;
