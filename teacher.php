    ...
    <?php
      ...
      /// --------Error Report End--------- ///
        ...
        // Insert Information into database //
			  $sql = "INSERT INTO teachers (Teacher_Name, Email_Address, 
        Home_Address, Phone_Number, Annual_Salary, Background_Check, Teacher_ID, 
        Class_ID) VALUES ('$Full_name', '$T_email', 
        '$T_address', '$T_phonenumber', '$T_annual_salary', 
        '$T_background_check', '$Teacher_ID', '$className')";
        echo $sql;
